...
function interpolate(
    ...
    return _interpolate!(Aout, A.data, I, architecture(A)) # perform interpolation, store in Aout
end
...
function interpolate!(
    ...
    return _interpolate!(Aout.data, A.data, interpolator, architecture(A))
end
...
function interpolate!(
    ...
    return _interpolate!(Aout, A.data, interpolator, architecture(A))  # use .data to trigger dispatch for method above
end
...
function update_locator!(
    ...
    return find_grid_indices!(I, λs, I.geometry.grid.architecture)               # next points left and right of λ on rings north and south
end
...
function update_locator!(I::AbstractInterpolator, A::Field; kwargs...)
    ...
    return update_locator!(I, londs, latds; kwargs...)
end
