...
# TYPES
function Architectures.nonparametric_type(::Type{<:OctaminimalGaussianGrid})
    OctaminimalGaussianGrid
end
full_grid_type(::Type{<:OctaminimalGaussianGrid}) = FullGaussianGrid

# FIELD
const OctaminimalGaussianField{
    T, N} = Field{T, N, ArrayType, Grid} where {ArrayType, Grid <: OctaminimalGaussianGrid}
...
function Base.showarg(io::IO,
        ...
        Grid <: OctaminimalGaussianGrid{A}} where {A <: AbstractArchitecture}
...
function get_npoints(::Type{<:OctaminimalGaussianGrid}, nlat_half::Integer)
    m,
    o = npoints_added_per_ring(OctaminimalGaussianGrid),
    npoints_pole(OctaminimalGaussianGrid)
...
## COORDINATES
function get_latd(::Type{<:OctaminimalGaussianGrid}, nlat_half::Integer)
...
## QUADRATURE
function get_quadrature_weights(::Type{<:OctaminimalGaussianGrid}, nlat_half::Integer)
