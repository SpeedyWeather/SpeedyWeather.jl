...
- Order-dependent, optimized quadrature weights for `HEALPixGrid` and `OctaHEALPixGrid`, massively improving transform exactness [#1240](https://github.com/SpeedyWeather/SpeedyWeather.jl/pull/1240)
