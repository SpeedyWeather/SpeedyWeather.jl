...
- `Parameterization` function stub for packages to define SpeedyWeather parameterizations in extensions [#NNNN](https://github.com/SpeedyWeather/SpeedyWeather.jl/pull/NNNN)
