...
- `TwoBandShortwave` (new default for `PrimitiveWetModel`) with visible and near-infrared band and `SeasonalOzone` following speedy.f90, fix precipitation units, static stability and max-RH cloud top in `DiagnosticClouds` [#PRNUM](https://github.com/SpeedyWeather/SpeedyWeather.jl/pull/PRNUM)
