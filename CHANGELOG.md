...
- Ensemble output dimension for `ZarrOutput`: multiple members can write into one shared store via `ensemble_index`/`n_ensemble` [#1150](https://github.com/SpeedyWeather/SpeedyWeather.jl/pull/1150)
