...
- Fix scalar indexing error constructing `SigmaCoordinates`/`Geometry` on GPU by validating `σ_half` on the host in `sigma_okay` [#1142](https://github.com/SpeedyWeather/SpeedyWeather.jl/pull/1142)
