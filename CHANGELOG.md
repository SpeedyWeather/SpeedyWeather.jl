...
- Avoid a keyword-argument dispatch (`Base.kwerr` dead branch) in the particle-initialization kernel that triggered AMDGPU hostcalls [#TODO](https://github.com/SpeedyWeather/SpeedyWeather.jl/pull/TODO)
