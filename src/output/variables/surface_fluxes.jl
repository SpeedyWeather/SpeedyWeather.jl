...
function path(::SurfaceSensibleHeatFluxOutput, simulation)
...
function path(::SurfaceHumidityFluxOutput, simulation)
...
function path(::SurfaceLatentHeatFluxOutput, simulation)
