...
#     geopotential!(column.geopotential, column.temp, model.geopotential, column.surface_geopotential)
...
#     (; dry_static_energy, geopotential, temp) = column

#     @inbounds for k in eachlayer(column)
#         dry_static_energy[k] = cₚ * temp[k] + geopotential[k]
#     end
