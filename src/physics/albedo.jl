...
function albedo!(diagn::DiagnosticVariables, progn::PrognosticVariables, model::PrimitiveEquation)
...
function ManualAlbedo(SG::SpectralGrid)
    ManualAlbedo{SG.NF, SG.GridVariable2D}(zeros(SG.GridVariable2D, SG.grid))
end
