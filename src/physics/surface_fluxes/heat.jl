...
function surface_heat_flux!(
    ...
    return surface_heat_flux!(column, heat_flux.land, progn, model)
end
...
function surface_heat_flux!(
    ...
    return column.sensible_heat_flux = flux_ocean      # diagnose/output: ocean sets the flux (=), land accumulates (+=)
end
...
function surface_heat_flux!(
    ...
    return column.sensible_heat_flux += flux_land      # ocean sets the flux (=), land accumulates (+=)
end
