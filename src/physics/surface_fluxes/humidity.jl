...
function SurfaceOceanHumidityFlux(SG::SpectralGrid; kwargs...)
    SurfaceOceanHumidityFlux{SG.NF}(; kwargs...)
end
...
function surface_humidity_flux!(
    ...
    flux_sea = isfinite(skin_temperature_sea) ?
               ρ*drag_sea*V₀*(sat_humid_sea - surface_humid) :
...
function SurfaceLandHumidityFlux(SG::SpectralGrid; kwargs...)
    SurfaceLandHumidityFlux{SG.NF}(; kwargs...)
end
