...
function set!(
    ...
    return set!(var, field, geometry, S; add)
end
...
function set!(
    ...
    return set!(var, var_new, geometry, S; add)
end
...
function set_vordiv!(
    ...
    return set_vordiv!(vor, div, u_L, v_L, geometry, S; add, coslat_scaling_included)
end
...
function set_vordiv!(
    ...
    return set_vordiv!(vor, div, u_spec, v_spec, geometry, S; add, coslat_scaling_included = true)
end
