...
function AdiabaticConversion(SG::SpectralGrid; kwargs...)
...
function initialize!(
    ...
    σ_lnp_A_cpu .= log.(σ_levels_half_cpu[1:(end - 1)] ./ σ_levels_half_cpu[2:end]) ./
                   σ_levels_thick_cpu
    ...
    σ_lnp_B_cpu .= 1 .-
                   σ_levels_half_cpu[1:(end - 1)] ./ σ_levels_thick_cpu .*
