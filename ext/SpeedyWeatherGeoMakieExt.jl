...
# Additional globe dispatches for Speedy types
RingGrids.globe(SG::SpectralGrid; kwargs...) = globe(SG.grid; kwargs...)
RingGrids.globe(geometry::Geometry; kwargs...) = globe(geometry.grid; kwargs...)
