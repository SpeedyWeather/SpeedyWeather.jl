...
function SpectralTransform(
    ...
    vordiv_to_uv_x = LowerTriangularMatrix(
        [-m/(l*(l+1)) for l in 0:(lmax - 1), m in 0:(mmax - 1)], spectrum_cpu)
...
# make commutative
function SpectralTransform(grid::AbstractGrid, spectrum::AbstractSpectrum; kwargs...)
...
# make commutative
function SpectralTransform(coeffs::LowerTriangularArray, field::AbstractField; kwargs...)
